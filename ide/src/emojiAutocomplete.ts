...
const PEPS_SUGGESTIONS: EmojiSuggestion[] = [
  ...
  entry("🧩", "function", ["function", "define", "def"], [], "Peps keyword"),
  ...
  entry("🔐", "constant", ["constant", "const", "readonly"], ["fixed", "immutable"], "Peps keyword"),
  ...
  entry("🔢", "integer / range", ["range", "number", "integer", "int"], ["input", "type"], "Peps keyword"),
  ...
  entry("📏", "length", ["length", "len", "size"], ["count", "text", "list", "map"], "Peps operator"),
  entry("🔎", "index", ["index", "get", "item"], ["lookup", "position", "text", "list", "map"], "Peps operator"),
  entry("🔑", "key exists", ["exists", "contains", "has key"], ["map", "dictionary", "key", "membership"], "Peps operator"),
